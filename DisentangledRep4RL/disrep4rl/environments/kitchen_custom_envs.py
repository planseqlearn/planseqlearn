...
register(
    ...
    entry_point='disrep4rl.environments.kitchen_custom_envs:KitchenMicrowaveV0',
...
register(
    id='kitchen-hinge-v0',
    entry_point='disrep4rl.environments.kitchen_custom_envs:KitchenHingeCabinetV0',
    max_episode_steps=280,
    kwargs={
    })
...
register(
    id='kitchen-tlb-v0',
    entry_point='disrep4rl.environments.kitchen_custom_envs:KitchenTopLeftBurnerV0',
    max_episode_steps=280,
    kwargs={
    })
...
register(
    ...
    entry_point='disrep4rl.environments.kitchen_custom_envs:KitchenKettleV0',
    max_episode_steps=280,
    kwargs={
    })
...
register(
    id='kitchen-light-v0',
    entry_point='disrep4rl.environments.kitchen_custom_envs:KitchenLightV0',
    max_episode_steps=280,
    kwargs={
    })
...
register(
    ...
    entry_point='disrep4rl.environments.kitchen_custom_envs:KitchenSliderV0',
    max_episode_steps=280,
    kwargs={
    })
...
register(
    ...
    entry_point='disrep4rl.environments.kitchen_custom_envs:KitchenKettleLightBurnerSliderV0',
    max_episode_steps=280,
    kwargs={
    }
)
...
register(
    ...
    entry_point='disrep4rl.environments.kitchen_custom_envs:KitchenKettleLightBurnerV0',
    max_episode_steps=280,
    kwargs={
    }
)
...
register(
    ...
    entry_point='disrep4rl.environments.kitchen_custom_envs:KitchenKettleBurnerV0',
    max_episode_steps=280,
    kwargs={
    }
)
...
register(
    ...
    entry_point='disrep4rl.environments.kitchen_custom_envs:KitchenLightBurnerV0',
    max_episode_steps=280,
    kwargs={
    }
)
...
register(
    ...
    entry_point='disrep4rl.environments.kitchen_custom_envs:KitchenMicrowaveKettleLightBurnerSliderV0',
    max_episode_steps=280,
    kwargs={
    }
)
...
register(
    id='kitchen-microwave-kettle-light-burner-v0',
    entry_point='disrep4rl.environments.kitchen_custom_envs:KitchenMicrowaveKettleLightBurnerSliderV0',
    max_episode_steps=280,
    kwargs={
    }
...
class KitchenMicrowaveKettleLightBurnerV0(KitchenBase):
