...
from disrep4rl.replay_buffer import ReplayBufferStorage
...
class Workspace:
    ...
    def __init__(self, cfg):
        ...
        if payload["task_name"].split("_")[0] == "metaworld":
            self.eval_env = make_metaworld(payload["task_name"].split("_")[1],
                                           payload["frame_stack"],
                                           payload["action_repeat"],
                                           payload["discount"], self.cfg.seed,
                                           payload["camera_name"],
            ...
            self.eval_env = make_adroit(payload["task_name"].split("_")[1],
                                        payload["frame_stack"],
                                        payload["action_repeat"],
                                        payload["discount"], self.cfg.seed,
                                        payload["camera_name"],
            ...
            self.eval_env = dmc.make(payload["task_name"],
                                     payload["frame_stack"],
                                     payload["action_repeat"], self.cfg.seed)
